...
public class HelloController {
    ...
    public void initialize(){
        ...
        wantsTodaysItems = new Predicate<ToDoItem>() {
            @Override
            public boolean test(ToDoItem toDoItem) {
                return LocalDate.now().equals(toDoItem.getDeadline());
            }
        };
    ...
    public void showNewItemDialog(){
        ...
        try{
            ...
            System.out.println("Can't log the dialog");
            e.printStackTrace();
            return;
        }
        ...
        if(result.isPresent() && result.get() == ButtonType.OK){
            DialogControler controler = fxmlLoader.getController();
            ToDoItem newItem = controler.processResults();
    ...
    public void deleteItem(ToDoItem item){
        ...
        alert.setTitle("Deleteing task");
        alert.setHeaderText("Delete item: " + item.getShortDescription());
        alert.setContentText("Are you sure? Press OK if so, or CANCEL to Back out.");
